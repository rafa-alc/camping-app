...
export const AppShell = ({
  ...
  const headerActionGroupClass =
    'flex w-full max-w-[23rem] items-center gap-1.5 rounded-full border border-white/28 bg-[linear-gradient(180deg,rgba(48,57,54,0.14)_0%,rgba(28,35,33,0.08)_100%)] px-1.5 py-1.5 shadow-[0_14px_28px_-24px_rgba(19,25,23,0.72)] backdrop-blur-md sm:w-fit sm:max-w-none';
  const headerActionButtonClass =
    'inline-flex min-w-0 flex-1 items-center justify-center rounded-full border px-2.5 py-1.5 text-center text-xs font-semibold leading-tight text-pine-800 transition-[transform,box-shadow,background-color,border-color,color] duration-200 ease-out border-[rgba(219,207,188,0.94)] bg-[linear-gradient(180deg,rgba(250,245,238,0.96)_0%,rgba(244,236,226,0.96)_100%)] shadow-[inset_0_1px_0_rgba(255,255,255,0.58),0_10px_18px_-18px_rgba(83,64,46,0.55)] hover:-translate-y-px hover:border-[rgba(205,191,172,0.96)] hover:bg-[linear-gradient(180deg,rgba(252,248,242,1)_0%,rgba(247,239,229,1)_100%)] hover:text-pine-900 sm:flex-none sm:px-3.5 sm:text-sm';
  const headerActionGhostClass =
    'inline-flex min-w-0 flex-1 items-center justify-center rounded-full border px-2.5 py-1.5 text-center text-xs font-medium leading-tight text-pine-700 transition-[transform,box-shadow,background-color,border-color,color] duration-200 ease-out border-[rgba(230,221,207,0.72)] bg-[linear-gradient(180deg,rgba(248,242,234,0.78)_0%,rgba(241,233,223,0.8)_100%)] shadow-[inset_0_1px_0_rgba(255,255,255,0.44),0_8px_16px_-18px_rgba(83,64,46,0.42)] hover:-translate-y-px hover:border-[rgba(217,206,190,0.92)] hover:bg-[linear-gradient(180deg,rgba(250,246,240,0.92)_0%,rgba(244,237,227,0.94)_100%)] hover:text-pine-800 sm:flex-none sm:px-3.5 sm:text-sm';
            ...
            <div className="w-full self-start sm:absolute sm:right-0 sm:top-0 sm:w-auto sm:self-auto">
              <div className={headerActionGroupClass}>
                {showAuthAction && authStatus === 'authenticated' && authDisplayName && (
                  <span className="inline-flex min-w-0 flex-1 items-center justify-center rounded-full border border-white/28 bg-white/90 px-2.5 py-1 text-xs font-medium text-pine-700 shadow-[0_8px_16px_-18px_rgba(53,41,29,0.45),inset_0_1px_0_rgba(255,255,255,0.42)] sm:max-w-[7.75rem] sm:flex-none">
